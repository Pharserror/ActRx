...
var ActRx = {
  ...
  naming: function naming(type) {
    ...
    return type.constructor.name !== 'String' ? function () {
      throw 'Every action supplied to ActionCreator must be a string!';
    }() : _settings2.default.DEFAULT_TYPES.concat(props).reduce(function (acc, prop) {
      return _extends({}, acc, _defineProperty({}, prop, type + '/' + prop));
    }, {});
  }
};
...
var SETTINGS = {
  DEFAULT_TYPES: ['REQUEST', 'SUCCESS', 'FAIL', 'CANCEL']
};
